...
// connect to db for bug 2
const db = new sqlite3.Database("./bug2db.db", sqlite3.OPEN_READWRITE, (err) => {
    if (err) {
...
router.get('/', (req, res) => {
    ...
    if (req.session.authorized) {
        res.sendFile(path.join(__dirname, '../../client/pages/bug2/bug2-loggedin.html'));
        console.log(`session_id: ${req.session.id}`);
    }
    else {
        res.sendFile(path.join(__dirname, '../../client/pages/bug2/bug2-loggedout.html'));
        console.log(`session_id: ${req.session.id}`);
    }
});
...
router.get('/posts', (req, res) => {
    ...
    console.log(`difficulty: ${security}. bug2 getting posts: ${search}`);
...
router.get('/login', (req, res) => {
    ...
    if (req.session.authorized) {
        return res.redirect('/bug2');
    }

    res.sendFile(path.join(__dirname, '../../client/pages/bug2/login.html'));
});
...
router.get('/register', (req, res) => {
    ...
    res.sendFile(path.join(__dirname, '../../client/pages/bug2/register.html'));
});
...
router.get('/profile', (req, res) => {
    ...
    res.sendFile(path.join(__dirname, '../../client/pages/bug2/profile.html'));
});
