...
async function checkIfCompleted() {
    let res = await fetch("/sqli/completed");
...
async function createPost() {
    ...
    let res = await fetch(`/sqli/posts`, {
        method: "POST",
        headers: {
...
function getSearchedPosts() { 
    if (searchPostsBar) {
        ...
        fetch(`/sqli/posts?search=${searchValue}`)
        .then(res => res.json())
        .then(data => {
            // console.log(data);
...
function deleteProfilePost(post_id) {
    fetch('/sqli/profile/delete-post', {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function login() {
    ...
    let res = await fetch(`/sqli/login`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function register() {
    ...
    let res = await fetch(`/sqli/register`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
